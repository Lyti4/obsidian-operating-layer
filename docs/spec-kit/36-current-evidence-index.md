...
- Remaining-link fresh selector pass: `out/reports/remaining-link-fresh-selector-v2/REPORT.md`, `out/reports/remaining-link-fresh-selector-v2/manual-review-selector/REPORT.md`, `out/reports/remaining-link-fresh-selector-v2/unified-operator-review-index/REPORT.md` — fresh selector validation over current remaining-link evidence; targeted pytest and `git diff --check` passed; selector/manual-review outputs remain proposal-only and do not authorize apply.
- Remaining-link nextgate review: `out/reports/remaining-link-operator-nextgate/20260707T0945Z/REPORT.md`, `out/reports/remaining-link-operator-nextgate/20260707T0945Z/operator-review-v1.json` — two unresolved items stay manual-only/no-apply because the protected-root candidate and Memory candidate are effectively tied.
