...
8. `26-nanobot-standing-worker.md` — Nanobot standing maintenance/communication worker contract.
9. `14-operational-acceptance-report.md`, `15-manual-and-adapter-acceptance.md`, `16-sandbox-e2e-evidence.md` — accepted evidence.
10. `docs/acceptance/index.md` — current accepted, conditional, and not-yet-accepted capabilities.
11. `docs/release-readiness.md` — release go/no-go gate.
12. `docs/runbooks/` — short operator workflows.
13. `docs/triage/kanban-board.md` — active board chain.
